...
val keyboardRows = persistentListOf<ImmutableList<NumKeyboardNumber>>(
  persistentListOf(
    NumKeyboardNumber.Seven(),
    NumKeyboardNumber.Eight(),
    NumKeyboardNumber.Nine(),
  ),
  persistentListOf(
    NumKeyboardNumber.Four(),
    NumKeyboardNumber.Five(),
    NumKeyboardNumber.Six(),
  ),
  persistentListOf(
    NumKeyboardNumber.One(),
    NumKeyboardNumber.Two(),
    NumKeyboardNumber.Three(),
  ),
  persistentListOf(
    NumKeyboardNumber.Zero(),
  ),
)
...
internal fun BaseNumericalKeyboardBottomSheet(
  ...
  onNumberClick: (numKeyboardNumber: NumKeyboardNumber) -> Unit,
